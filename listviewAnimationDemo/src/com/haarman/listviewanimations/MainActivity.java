...
public class MainActivity extends Activity {
	...
	protected void onActivityResult(final int requestCode,
		...
		if (resultCode == RESULT_OK) {
			Toast.makeText(this, getString(R.string.thanks), Toast.LENGTH_LONG)
					.show();
	...
	private void buy(final String sku) {
		try {
			...
			Toast.makeText(this, getString(R.string.exception),
	...
	private class RetrievePurchasesRunnable implements Runnable {
		...
		public void run() {
			try {
				...
				if (response == 0) {
					Iterable<String> purchaseDataList = ownedItems
				...
				Toast.makeText(MainActivity.this,
						getString(R.string.exception), Toast.LENGTH_LONG)
						.show();
